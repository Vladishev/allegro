<?php
class Orba_Allegro_Block_Adminhtml_Template_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    protected $_attributeTabBlock = 'orbaallegro/adminhtml_template_edit_tab_attributes';

    public function __construct()
    {
        parent::__construct();
        $this->setId('orbaallegro_info_tab');
        $this->setDestElementId('template_edit_form');
        $this->setTitle(Mage::helper('orbaallegro')->__('Template Information'));
    }
    ...
    protected function _prepareLayout()
    {
        ...
        if($countryCode){
            ...
            $groupCollection = Mage::getResourceModel('eav/entity_attribute_group_collection')
                    ->setAttributeSetFilter($model->getAttributeSetId())
                    ->setSortOrder()
                    ->load();
             ...
             foreach ($groupCollection as $group) {
                    ...
                    $attributes = $model->getAttributes($group->getId(), true);
                        ...
                        'content'   => $this->_translateHtml(
                            $this->getLayout()->
                                createBlock(
                                    ...
                                    'adminhtml.orbaallegro.template.edit.tab.attributes'
                                )->
                                    setGroup($group)->
        ...
        // Make setting tab
             ...
             $this->addTab('group_settings', array(
                ...
                'content'   => 
                    $this->getLayout()->
                        createBlock(
                            "orbaallegro/adminhtml_template_edit_tab_settings",
                            'adminhtml.orbaallegro.trmplate.edit.tab.settings'
                        )->toHtml(),
            ));
        }
