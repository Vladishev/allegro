...
class Orba_Allegro_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    const SCOPE_GLOBAL                          = 1;
    const SCOPE_WEBSITE                         = 2;

    const MODULE_NAME                           = 'Orba_Allegro';
    const ENTITY                                = 'orba_allegro_eav_attribute';
     ...
     * @var string
     */
    protected $_eventPrefix                     = 'orba_allegro_entity_attribute';
    /**
     * Event object name
     *
     * @var string
    ...
    {
        $this->_init('orbaallegro/attribute');
    }
    ...
    public static function initLabels($storeId = null)
    {
        if (is_null(self::$_labels)) {
            ...
            $attributes = Mage::getResourceSingleton('orbaallegro/template')->getAttributesByCode();
