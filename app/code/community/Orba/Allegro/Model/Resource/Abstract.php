...
abstract class Orba_Allegro_Model_Resource_Abstract extends Mage_Eav_Model_Entity_Abstract
{
    /**
    ...
    {
        return 'orbaallegro/resource_eav_attribute';
    }
    ...
    {
        return Orba_Allegro_Model_Abstract::DEFAULT_STORE_ID;
    }
     ...
     *
     * @param Orba_Allegro_Model_Abstract $object
     * @param array $valueRow
     * @return Orba_Allegro_Model_Resource_Abstract
     */
     ...
     * @see Orba_Allegro_Model_Resource_Abstract::_saveAttributeValue()
     *
     * @param Varien_Object $object
     * @param Mage_Eav_Model_Entity_Attribute_Abstract $attribute
     * @param mixed $valueId
    ...
    public function getAttributeRawValue($entityId, $attribute, $store)
    {
        ...
        foreach ($attribute as $_attribute) {
            /* @var $attribute Orba_Allegro_Model_Entity_Attribute */
